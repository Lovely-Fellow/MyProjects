        ...
        <form method="post" id="form_submit" enctype="multipart/form-data" action="<?php echo $url;?>ajax.php">
            ...
            <div class="row margin_image_20">
                ...
                <div class="col-lg-2">
                    ...
                    <label>&nbsp;</label>
                        <input type="Submit" id="cmdCreate" class="form-control btn btn-primary" value="Add New Contact" />
                    </div>
                </div>
				<div class="col-lg-1">
					 <div class="from-group" style="">
                     <label>&nbsp;</label>  
						<input id="cmdUpdate" type="Button" value="Update Contact" class="btn btn-info" disabled="disabled"/>
                     </div>     
                </div>
				<div>
...
?>
 ...
 <?php if(isset($current_data) && !empty($current_data)){
     ...
     foreach($current_data as $single){
         ?>
            <tr>
                <td class="selimg" data-id=<?php echo $single['id'];?> data-value=<?php echo $single['photo'];?>><img class="single_image_sec" src="<?php echo $single['photo'];?>" /></td>
                <td class="selname" data-id=<?php echo $single['id'];?> data-value="<?php echo $single['name'];?>"><?php echo $single['name'];?></td>
                <td class="selphone" data-id=<?php echo $single['id'];?> data-value="<?php echo $single['phone'];?>"><?php echo $single['phone'];?></td>
                <td><a class="fa fa-facebook" href="https://facebook.com/ID"/>  
				<a class="fa fa-instagram" href="https://instagram.com/ID"/>
				<a class="fa fa-twitter" href="https://twitter.com/ID"/>
				<a class="fa fa-github" href="https://github.com/ID"/>
                ...
                Delete</a></td>
				<td><a class="btn btn-sm btn-info updateContact" data-id=<?php echo $single['id'];?> style="color: #fff" > 
