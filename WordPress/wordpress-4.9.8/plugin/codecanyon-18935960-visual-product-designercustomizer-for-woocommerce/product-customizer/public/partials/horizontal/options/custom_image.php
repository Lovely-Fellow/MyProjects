<div class="shop-filter__options-wrapper shop-filter__options-wrapper--block" data-sf-group="options"
    ...
    <?php foreach ($component['options'] as $optionKey => $option): ?>
        <?php if ($option['option_enable'] == 1): ?>
            ...
            <div
                    class="shop-filter__option--block shop-filter__option  <?php echo ($option['option_default']) ? 'is-default' : ''; ?>"
