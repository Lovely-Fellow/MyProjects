<?php if (!$component_radio_button): ?><div class="shop-filter__options-list"><?php endif; ?>
    <?php if (!empty($groups)): ?>
        <?php foreach ($groups as $group): ?>
            <div class="shop-filter__groups-wrapper">
                <?php $first_option = reset($group);
                if (!empty($first_option)):?>
                    <div class="shop-filter__options__title group_title"><?php echo $first_option['group_name']; ?></div>
                <?php endif; ?>
                <?php foreach ($group as $optionKey => $option): ?>
                    <?php if ($option['option_enable'] == 1): ?>
                        ...
                        <?php if ($component_radio_button): ?>
                            ...
                            <div class="shop-filter__radio <?php echo !empty($option['option_default']) ? 'is-default' : ''; ?>"
                                data-sf-elem="option"
        ...
        <?php endforeach; ?>
    <?php endif; ?>
<?php if (!$component_radio_button): ?></div><?php endif; ?>
